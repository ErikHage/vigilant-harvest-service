const allPlantingFields: string = 'planting_id, plot_id, plant_id, num_plants, planting_year, planting_name, lot_number, notes ';

const plantings = {
  upsert: `
    INSERT into plantings (planting_id, plot_id, plant_id, num_plants, planting_year, planting_name, lot_number, notes)
    VALUES (?,?,?,?,?,?,?,?)
    ON DUPLICATE KEY
